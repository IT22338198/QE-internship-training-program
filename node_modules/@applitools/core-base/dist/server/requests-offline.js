...
function makeCoreRequestsOffline({ folderPath, logger: defaultLogger, }) {
    ...
    async function getAccountInfo() {
        ...
        return {
            ...
            ecEnabled: true,
            processKeepaliveIntervalSec: 0, // disable heartbeat
        };
    }
...
function getNameForFolder(settings) {
    return `test-${crypto_1.default
        .createHash('md5')
        .update(JSON.stringify({ testName: settings.testName, environment: settings.environment, appName: settings.appName }))
        .digest('hex')}`;
}
